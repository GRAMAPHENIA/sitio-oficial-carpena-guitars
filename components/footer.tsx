      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Fabricantes de guitarras y bajos personalizados de alta calidad desde 2005.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/guitarras" className="text-muted-foreground hover:text-foreground transition-colors">
                  Guitarras
                </Link>
              </li>
              <li>
                <Link href="/bajos" className="text-muted-foreground hover:text-foreground transition-colors">
                  Bajos
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/bajos/custom" className="text-muted-foreground hover:text-foreground transition-colors">
                  Bajos Custom
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">Recibe noticias y ofertas exclusivas</p>
            <form className="space-y-2">
              <Input type="email" placeholder="Tu email" className="bg-background" required />
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} GuitarBrand. Todos los derechos reservados.
          </p>
