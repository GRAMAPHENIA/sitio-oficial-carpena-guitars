...
export async function generateStaticParams() {
    const models = new Set(featuredGuitars.map((guitar) => guitar.href.split("/")[2]));
    return Array.from(models).map((model) => ({ model }));
}
...
export function generateMetadata({ params }: Props): Metadata {
    ...
    return {
        title: `Guitarras ${capitalize(modelName)} | Modelos de 6, 7 y 8 cuerdas`,
        description: `Explora nuestra colección de guitarras ${capitalize(modelName)}. Modelos de 6, 7 y 8 cuerdas con diseños únicos y sonidos excepcionales.`,
    };
}
    ...
    return (
        <div className="container mx-auto py-12 px-4 md:px-6">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-8 text-sm text-muted-foreground">
                ...
                <ChevronRight className="h-4 w-4" />
                <span className="text-foreground">{capitalize(modelName)}</span>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
                <div>
                    <h1 className="text-3xl md:text-4xl font-bold mb-4">Guitarras {capitalize(modelName)}</h1>
                ...
                <div className="relative h-[400px] rounded-lg overflow-hidden">
                    <Image
                        ...
                        alt={`Guitarra ${capitalize(modelName)}`}
                        fill
...
// ———————————————————————————————————————
// HELPER FUNCTIONS (moved to keep component cleaner)
// ———————————————————————————————————————
